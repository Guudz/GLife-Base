  ...
  if takePhoto ~= true then
    ...
    hasPhone(function (hasPhone)
      if hasPhone == true then
        TriggerServerEvent("gcphone:Connected")
        setBankBalance(exports["aCore"]:getCurrentTel())
        TooglePhone()
      else
        ShowNoPhoneWarning()
      end
...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  if hasFocus == true then
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
      exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/844156753565974528/7m1RHc6PLjHNGnyA1zKJuR51XBDWExu8IKw7qs91UrW9F3QpZD-Qcw3wb9W3LNPgy5O8", data.field, function(data)
