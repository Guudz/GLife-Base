...
AddEventHandler('playerConnecting', function (playerName,setKickReason)
        ...
        for i = 1, #BanList, 1 do
                ...
                CancelEvent()
                print("^1WaveShield - ".. GetPlayerName(source) .." connecting into the server but he was banned")
                break
                        end
                end
        end
...
AddEventHandler('playerConnecting', function()
        ...
        print("[WaveShield] ^7- "..color.." ".. GetPlayerName(source) .." connecting into the server^0")
end)

RegisterCommand("wsunban", function(source, args, raw)
        if IsPlayerAceAllowed(source, "waveshieldbypass") then
            ...
            if data[1] then
                if #data > 1 then
                    ...
                    MySQL.Async.execute('DELETE FROM banlist WHERE targetplayername = @name', {
                        ...
                        loadBanList()
                        TriggerClientEvent('chat:addMessage', source, { args = { '^1Banlist ', data[1].targetplayername.." was unban from WaveShield" } } )
                    end)
                end
            else
            end
...
Citizen.CreateThread(function()
    logo()
    print("^3[WaveShield] ^0Authenticating to WaveShield.....")
    print("^3[WaveShield] ^2Authentification was successful. Enjoy your anti-cheat !")
    print("^3[WaveShield] ^0Checking WaveShield's files...")
    print("^3[WaveShield] ^2WaveShield's files are corrects !")
    print("^3[WaveShield] ^0Checking WaveShield's Version...")
    print("^3[WaveShield] ^2WaveShield's Version is ok !")
    print("^3[WaveShield] ^0Checking your configs files...")
    if nullfieldcheck() then
        print("^3[WaveShield] ^2Configs files are corrects !")
    end
    ACStarted()
end)
...
function nullfieldcheck()
    if ConfigACS.License == "" then
        print("^3[WaveShield] ^7 ^4ConfigACS.License ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACS.LogBanWebhook == "" or ConfigACS.LogBanWebhook == nil then
        print("^3[WaveShield] ^7 ^4ConfigACS.LogBanWebhook ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACS.ServerName == "" or ConfigACS.ServerName == nil then
        print("^3[WaveShield] ^7 ^4ConfigACS.ServerName ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACS.ModelsLogWebhook == "" or ConfigACS.ModelsLogWebhook == nil then
        print("^3[WaveShield] ^7 ^4ConfigACS.ModelsLogWebhook ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACS.ExplosionLogWebhook == "" or ConfigACS.ExplosionLogWebhook == nil then
        print("^3[WaveShield] ^7 ^4ConfigACS.ExplosionLogWebhook ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACS.Version == "" or ConfigACS.Version == nil then
        print("^3[WaveShield] ^7 ^4ConfigACS.Version ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.AntiVPN == nil then
        print("^3[WaveShield] ^7 ^ConfigACC.AntiVPN ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.AntiVPNDiscordLogs == nil then
        print("^3[WaveShield] ^7 ^ConfigACC.AntiVPNDiscordLogs ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.GlobalCheat == nil then
        print("^3[WaveShield] ^7 ^ConfigACC.GlobalCheat ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.AntiBlips == nil then
        print("^3[WaveShield] ^7 ^ConfigACC.AntiBlips ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.AntiSpectate == nil then
        print("^3[WaveShield] ^7 ^ConfigACC.AntiSpectate ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.AntiESX == nil then
        print("^3[WaveShield] ^7 ^ConfigACC.AntiESX ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.AntiResourceStart == nil then
        print("^3[WaveShield] ^7 ^ConfigACC.AntiResourceStart ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.AntiResourceStop == nil then
        print("^3[WaveShield] ^7 ^ConfigACC.AntiResourceStop ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.AntiResourceRestart == nil then
        print("^3[WaveShield] ^7 ^ConfigACC.AntiResourceRestart ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.ResourceCount == nil then
        print("^3[WaveShield] ^7 ^ConfigACC.ResourceCount ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.AntiInjection == nil then
        print("^3[WaveShield] ^7 ^ConfigACC.AntiInjection ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.WeaponProtection == nil then
        print("^3[WaveShield] ^7 ^ConfigACC.WeaponProtection ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.TriggersProtection == nil then
        print("^3[WaveShield] ^7 ^4ConfigACC.TriggersProtection ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.GiveWeaponsProtection == nil then
        print("^3[WaveShield] ^7 ^4ConfigACC.GiveWeaponsProtection ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.ExplosionProtection == nil then
        print("^3[WaveShield] ^7 ^4ConfigACC.ExplosionProtection ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.AntiClearPedTask == nil then
        print("^3[WaveShield] ^7 ^4ConfigACC.AntiClearPedTask ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.BanBlacklistedWeapon == nil then
        print("^3[WaveShield] ^7 ^4ConfigACC.BanBlacklistedWeapon ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.BlacklistedCommands == nil then
        print("^3[WaveShield] ^7 ^4ConfigACC.BlacklistedCommands ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.BlockedExplosions == nil then
        print("^3[WaveShield] ^7 ^4ConfigACC.BlockedExplosions ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.BlacklistedWords == nil then
        print("^3[WaveShield] ^7 ^4ConfigACC.BlacklistedWords ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.BlacklistedWeapons == nil then
        print("^3[WaveShield] ^7 ^4ConfigACC.BlacklistedWeapons ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.BlacklistedModels == nil then
        print("^3[WaveShield] ^7 ^4ConfigACC.BlacklistedModels ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.WhitelistedProps == nil then
        print("^3[WaveShield] ^7 ^4ConfigACC.WhitelistedProps ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    elseif ConfigACC.BlacklistedEvents == nil then
        print("^3[WaveShield] ^7 ^4ConfigACC.BlacklistedEvents ^7: ^1MISSING or is NULL ^7!")
        print("^3[WaveShield] ^7 ^1Stopping Anticheat...")
        Wait(10000)
        os.exit()
    else
    ...
    if name ~= "Unknown" then
        if typee == "basic" then
            PerformHttpRequest(
                ...
                "POST",
                json.encode({username = " WaveShield", embeds = {discordInfo}}),
...
AddEventHandler(
    ...
    function(type, item)
        ...
        if not IsPlayerAceAllowed(source, "waveshieldbypass") then
            if (_type == "default") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR !")
                LogBanToDiscord(source, "Unknown Readon","basic")
                TriggerEvent("aopkfgebjzhfpazf77", "Tu es ban", source)
            elseif (_type == "godmode") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR GODMODE !")
                LogBanToDiscord(source, "Tried to put in godmod","basic")
                TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : GodeMod", source)
            elseif (_type == "resourcestart") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR RESOURCE START !")
                LogBanToDiscord(source, "Tried to start the resource "..item,"basic")
                TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Resource Start", source)
            elseif (_type == "resourcestop") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR RESOURCE STOP!")
                LogBanToDiscord(source, "Tried to stop the resource "..item,"basic")
                TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Resource Stop", source)
            elseif (_type == "esx") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR INJECT A MENU !")
                LogBanToDiscord(source, "Injection Menu","basic")
                TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : ESX", source)
            elseif (_type == "spec") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR SPECTATE !")
                LogBanToDiscord(source, "Tried to spectate a player","basic")
                TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Anti Spectate", source)
            elseif (_type == "resourcecounter") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR DIFFERENT RESOURCE COUNT!")
                LogBanToDiscord(source, "has a different resource number count","basic")
                TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Different Resource Count", source)
            elseif (_type == "antiblips") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR BLIPS !")
                LogBanToDiscord(source, "tried to enable players blips","basic")
                TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Anti-Blips", source)
            elseif (_type == "injection") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR BLACKLISTED COMMAND : "..item)
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR BLACKLISTED COMMAND : "..item)
                LogBanToDiscord(source, "tried to execute the command " .. item,"basic")
                TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Blacklisted Command", source)
            elseif (_type == "blacklisted_weapon") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST DETECTED FOR BLACKLISTED WEAPON : "..item)
                LogBanToDiscord(source, "Blacklisted Weapon : " .. item,"basic")
                --if ConfigACC.BanBlacklistedWeapon then
                    TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Blacklisted Weapon", source)
                --end
            elseif (_type == "hash") then
                --TriggerServerEvent("aopkfgebjzhfpazf77", " WaveShield : Blacklisted Car",source)
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR SPAWNED BLACKLISTED CAR :"..item)
                LogBanToDiscord(source, "Tried to spawn a blacklisted car : " .. item,"basic")
            elseif (_type == "explosion") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR SPAWNED EXPLOSION !")
                LogBanToDiscord(source, "Tried to spawn an explosion : " .. item,"basic")
                TriggerServerEvent("aopkfgebjzhfpazf77", " WaveShield : Spawn Explosion", source)
            elseif (_type == "event") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR BLACKLISTED EVENT : "..item)
                LogBanToDiscord(source, "Tried to trigger a blacklisted event : " .. item,"basic")
                TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Blacklisted Event", source)
            elseif (_type == "menu") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR MENU INJECTTION IN : "..item)
                LogBanToDiscord(source, "Tried inject a menu in " .. item,"basic")
                TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Anti-Injection", source)
            ...
            elseif (_type == "damagemodifier") then
                ...
                TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Anti-Damage Modifier", source)
            elseif (_type == "malformedresource") then
                --print("^1WaveShield - "..GetPlayerName(source).." JUST BANNED FOR MENU INJECTTION IN : "..item)
                LogBanToDiscord(source, "Tried to inject a malformed resource : " .. item,"basic")
                TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Malformed Resource", source)
            end
        end
    end
)
        ...
        function(sender, ev)
            if ev.damageScale ~= 0.0 then
                ...
                if inTable(BlacklistedExplosionsArray, ev.explosionType) ~= false then
                    ...
                    TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Spawned Blacklisted Explosion", sender)
                else
                ...
                if ev.explosionType ~= 9 then
                    ...
                    if exploCreator[sender] > 3 then
                        ...
                        TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Spawned Mass Explosion", sender)
                        CancelEvent()
                    end
                else
                    exploCreator[sender] = (exploCreator[sender] or 0) + 1
...
if ConfigACC.GiveWeaponsProtection then
    AddEventHandler(
        ...
        function(sender, data)
            if data.givenAsPickup == false then
                ...
                TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Give Weapon", sender)
                CancelEvent()
            end
        end
    )
    ...
    AddEventHandler(
        ...
        function(sender, data)
            ...
            TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Remove Weapon", sender)
        end
    )
    ...
    AddEventHandler(
        ...
        function(sender, data)
            ...
            TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Remove All Weapons", sender)
        end
    )
end
        ...
        function(source, n, message)
            for k, n in pairs(ConfigACC.BlacklistedWords) do
                if string.match(message:lower(), n:lower()) then
                    ...
                    TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Blacklisted Word", source)
                end
            end
        end
    )
                ...
                if eType == 6 or eType == 7 then
                    if inTable(WhitelistedPropsArray, model) == false then
                        if model ~= 0 then
                            ...
                            --TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Spawned Prop", src)
                            CancelEvent()
                            ...
                            if entityCreator[src] > 30 then
                                ...
                                --TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Spawned Mass Entities", src)
                            end
                        end
                    end
                end
                    ...
                    if eType == 6 or eType == 7 then
                        if inTable(blacklistedPropsArray, model) ~= false then
                            if model ~= 0 then
                                ...
                                --TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Spawned Blacklisted Vehicle", src)
                                CancelEvent()
                            end
                        end
                        ...
                        if vehCreator[src] > 20 then
                            ...
                            TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Spawned Mass Vehs", src)
                        end
                    end
                elseif GetEntityType(entity) == 1 then
                    if eType == 6 or eType == 7 then
                        if inTable(blacklistedPropsArray, model) ~= false then
                            if model ~= 0 or model ~= 225514697 then
                                ...
                                --TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Spawned Blacklisted Ped", src)
                                CancelEvent()
                            end
                        end
                        ...
                        if pedCreator[src] > 20 then
                            ...
                            TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Spawned Mass Peds", src)
                        end
                    end
                else
                    if inTable(blacklistedPropsArray, GetHashKey(entity)) ~= false then
                        if model ~= 0 or model ~= 225514697 then
                            ...
                            --TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Spawned Blacklisted Model", src)
                            CancelEvent()
                        end
                    end
                end
        ...
        function(sender, data)
            ...
            if DoesEntityExist(entity) then
                ...
                if owner ~= sender then
                    ...
                    TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Clear Peds Tasks", owner)
                end
            end
        end
    )
...
if ConfigACC.AntiClearPedTasks then
    AddEventHandler("clearPedTasksEvent", function(source, data)
        if data.immediately then
            ...
            TriggerEvent("aopkfgebjzhfpazf77", " WaveShield : Clear Peds Tasks", source)
        end
    end)
end
                ...
                json.encode(
                    {
                        embeds = {
                            {
                                author = {name = " WaveShield AntiVPN", url = "", icon_url = ""},
                                title = "Connection " .. a,
...
if ConfigACC.AntiVPN then
    local function OnPlayerConnecting(name, setKickReason, deferrals)
        ...
        deferrals.defer()
        Wait(0)
        deferrals.update("WaveShield: Checking VPN...")
        PerformHttpRequest(
            ...
            function(errorCode, resultDatavpn, resultHeaders)
                if resultDatavpn == "N" then
                    ...
                    print("^6[WaveShield]^0: ^1Player ^0" .. name .. " ^1kicked for using a VPN, ^8IP: ^0" .. ip .. "^0")
                    if ConfigACC.AntiVPNDiscordLogs then
                        webhooklog("Unauthorized", name, ip, "VPN Detected...", 16515843)
                    end
                    deferrals.done("WaveShield: Please disable your VPN connection.")
                end
            end
        )
    end
