...
local Infos = { 
    ...
    ["bank_card"] = function() 
        RageUI.Popup({message="Titulaire :~b~".. Inventory.SelectedItem.data.name .. "\n~s~Type de carte :~b~" .. Inventory.SelectedItem.data.type .. "\n~s~Numéro de carte :~b~" .. Inventory.SelectedItem.data.number}) 
                    ...
                    function() 
                        ...
                        RageUI.Button( 
                            ...
                            function(_, _, Selected) 
                                if Selected then 
                                    Inventory:Throw() 
                                    ExecuteCommand('me Jete un objet.')
                                --Inventory:Delete() 
                                end 
                            end 
                        ) 
