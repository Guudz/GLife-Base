...
function JobListing.Open()
 ...
 Citizen.CreateThread(function()
     ...
     AddTextComponentString("Recherche d'emplois")
     EndTextCommandSetBlipName(blip)
     Zone:Add({x=-544.93,y=-204.00,z=37.21,a=209.06},JobListing.EnterZone,JobListing.ExitZone,nil,2.5)
     Ped:Add("Marc","ig_bankman",{x=-544.93,y=-204.00,z=37.21,a=209.06},nil)
                ...
                RageUI.DrawContent({ header = false, glare = false}, function()
                    ...
                    RageUI.Button("Ajouter une annonce",nil,{},true,function(_,_,Selected)
                        if Selected then
                            ...
                            local salary = KeyboardInput("Salaire","",4)
