...
---LoadingPrompt
---
--- Reference : https://github.com/citizenfx/fivem/blob/master/code/client/claCore/External/Screen.cs#L341
---
...
---LoadingPromptHide
---
--- Reference : https://github.com/citizenfx/fivem/blob/master/code/client/claCore/External/Screen.cs#L361
---
---@return void
